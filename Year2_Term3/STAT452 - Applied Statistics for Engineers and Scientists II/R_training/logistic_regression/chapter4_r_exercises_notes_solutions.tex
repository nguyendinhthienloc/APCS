...
\begin{answer}{1} Linear regression is not guaranteed to respect probability bounds; inspect \texttt{range(predict(linear\_binary))}. This motivates the logistic link.\end{answer}
