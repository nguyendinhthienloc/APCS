...
$\mathcal{F}$ & AGGREGATE* & Extended RA: e.g. $Dno\;\mathcal{F}_{\mathrm{COUNT}(*)}(EMPLOYEE)$\\
\bottomrule
\end{tabularx}
\end{center}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item $\text{REVIEWER} \xleftrightarrow{M:N} \text{PAPER}$ [REVIEW] (Total on PAPER side 1..N; Partial on REVIEWER side 0..N).
  \end{itemize}
  \item \textbf{Relational Schema:}
  \begin{align*}
